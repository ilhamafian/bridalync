export default function ShellLayout({
  ...
  return (
    <div className="flex h-dvh items-center justify-center overflow-x-hidden bg-background font-serif max-md:py-0 md:bg-zinc-200 md:py-6 dark:md:bg-zinc-950">
